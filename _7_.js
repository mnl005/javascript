...
//     oo: function(){console.log('asdfasdf');} // 사라짐
// };
...
//m1('P/OST','http://localhost:3000/api/data',{a:1123});
...
// new Promise(resolve => resolve('리졸브'))
...
// ... setTimeout 함수는 테스크 큐이고, 우선순위가 마이크로테스크큐보다 낮다
